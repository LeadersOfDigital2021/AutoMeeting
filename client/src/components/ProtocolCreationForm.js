        ...
        <div className="w-full p-10 bg-white rounded-xl z-10">
            ...
            <div className=" flex content-center">
            {
                state.isWordDocCreated && state.file.id ? (
                    <a href={`http://109.248.175.110:8080/download/${state.file.id}`} className="center downloadLink bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
